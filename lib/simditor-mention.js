(function() {
  ...
  Mention = (function(_super) {
    ...
    Mention.prototype._init = function() {
      ...
      if (this.opts.mention.items.length === 0 && this.opts.mention.url === "") {
    ...
    Mention.prototype.selectItem = function() {
      var $itemLink, object, range, selectedItem, spaceNode;
      ...
      object = this.items[selectedItem.attr('data-index')];
      object["el"] = $itemLink[0];
      $(this.editor).trigger("mention", object);
    ...
    Mention.prototype._onKeyDown = function(e) {
      var itemEl, itemH, node, parentEl, parentH, position, selectedItem;
      if (!this.active) {
        return;
      }
      if (e.which === 37 || e.which === 39 || e.which === 27) {
        ...
        itemEl = selectedItem[e.which === 38 ? 'prev' : 'next']('.item:visible');
        if (itemEl.length > 0) {
